  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (!matchData) {
          logError(new Error('Match not found'), { source: 'ChatThreadPage', matchId });
          setLoading(false);
          return;
        }
        ...
        logError(error instanceof Error ? error : new Error('Error fetching chat data'), { source: 'ChatThreadPage', matchId });
        setLoading(false);
      }
    };
