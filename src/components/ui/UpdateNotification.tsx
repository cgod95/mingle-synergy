...
const UpdateNotification = () => {
  ...
  return (
    <div className={`fixed bottom-16 inset-x-0 mx-auto w-max p-4 bg-violet-600 text-white rounded-lg shadow-lg z-50 ${
      ...
      <div className="flex items-center space-x-3">
        ...
        <button 
          ...
          className="px-4 py-1 bg-white text-violet-600 rounded-full font-medium text-sm"
        >
          Refresh
        </button>
      </div>
